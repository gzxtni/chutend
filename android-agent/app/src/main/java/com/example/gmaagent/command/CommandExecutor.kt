...
object CommandExecutor {
    ...
    // ── send_sms: Open the default SMS app with pre-filled content ──
    ...
    private fun executeSendSms(context: Context, payload: String?): Pair<Boolean, String> {
        ...
        return try {
            ...
            Pair(true, "SMS app opened for $to with pre-filled message")
        } catch (e: Exception) {
            Log.e(TAG, "Failed to open SMS app", e)
            Pair(false, "Failed to open SMS app: ${e.message}")
        }
    }
